...
//keyboard input
CAPI b8 InputIsKeyDown(Keys _key);
CAPI b8 InputIsKeyUp(Keys _key);
CAPI b8 InputWasKeyDown(Keys _key);
CAPI b8 InputWasKeyUp(Keys _key);

void InputProcessKey(Keys _key, b8 _pressed);

//mouse input
CAPI b8 InputIsButtonDown(Buttons _button);
CAPI b8 InputIsButtonUp(Buttons _button);
CAPI b8 InputWasButtonDown(Buttons _button);
CAPI b8 InputWasButtonUp(Buttons _button);
CAPI void InputGetMousePosition(i32* _x, i32* _y);
CAPI void InputGetPreviousMousePosition(i32* _x, i32* _y);
